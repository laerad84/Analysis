void PI0MassCompare(){
  ...
  TH1D* hisBeamPi0Mom = new TH1D("hisBeamMom","hisBeamMom",500,0,5000);
  TH1D* hisSimPi0Mom  = new TH1D("hisSimMom","hisSimMom",500,0,5000);
  

  chBeam->Project(hisBeamMass->GetName(),
		  "Pi0Mass[0]",
		   "GammaE[0]>200&&GammaE[1]>200&&GammaChi2[0]<5&&GammaChi2[1]<5");
  ...
  chSim->Project(hisSimGamma->GetName(),
		 "GammaE",
		 "GammaE[0]>200&&GammaE[1]>200&&GammaChi2[0]<5&&GammaChi2[1]<5");
  chBeam->Project(hisBeamPi0Mom->GetName(),
		 "Pi0E[0]",
		 "GammaE[0]>200&&GammaE[1]>200&&GammaChi2[0]<5&&GammaChi2[1]<5");
  chSim->Project(hisSimPi0Mom->GetName(),
		 "Pi0E[0]",
		 "GammaE[0]>200&&GammaE[1]>200&&GammaChi2[0]<5&&GammaChi2[1]<5");
