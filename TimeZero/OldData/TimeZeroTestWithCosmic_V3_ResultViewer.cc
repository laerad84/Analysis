...
main( int argc, char** argv ){
  ...
  TFile* tf = new TFile("CosmicOut_V3.root");
  ...
  TFile* tfout = new TFile("CosmicOut_V3_hist.root", "recreate");
  ...
  TPostScript* ps  = new TPostScript("CosmicOut_V3_hist.ps",111);
  ...
  std::ifstream ifs("CosmicOut_V2_TimeDeltaResolution.dat");
  std::ofstream ofs("CosmicOut_V3_TimeDeltaResolution.dat");
  int    ID[2716];
  double Delta[2716];
