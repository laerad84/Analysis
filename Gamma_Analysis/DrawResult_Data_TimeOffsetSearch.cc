...
int main( int argc, char** argv) {
  ...
  Int_t EnergyBoundary[nRegion+1] = {100,200,300,500,800,1300};
  Int_t CEnergyBoundary[nRegion+1]= {50,100,150,250,400,650};
  ...
  for( int ievent = 0; ievent < nEntries; ievent++){
    ...
    for( int clusterIndex = 0; clusterIndex < reader->nCluster; clusterIndex++){
      ...
      if( TMath::Abs(clusterR*TMath::Cos(clusterTheta)) < 150 && TMath::Abs( clusterR*TMath::Sin(clusterTheta)) < 150 ){ continue; }
