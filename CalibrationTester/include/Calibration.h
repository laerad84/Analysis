...
class Calibration {
 private:
  ...
  double m_firstChisq[6]; // FirstChisquare Value of Gamma
 ...
 public:
  ...
  //
  const static double chisqCut      = 10.;//1
  const static double KLMassCut     = 10.;//2
  const static double pimassCut     = 6.;
  const static double gammadistCut  = 150.;//32
  const static double deltachisqCut = 5.;//64 
  const static double gammaEneCut   = 100.;//128

  //
  const static double gammaChisqCut = 5.;
  const static double deltaCalibrationZCut = 200;
  ...
  Calibration();
  ~Calibration();
  double GetCorr(int i){ return m_Corr[i];}
  double GetCorrE(int i){ return m_CorrE[i];}
  double GetChisq(int i){ return m_chisq[i];}
  double GetFirstChisq(int i){ return m_firstChisq[i];}
  int GetNCalibrated(){ return m_nCalibrated;}
