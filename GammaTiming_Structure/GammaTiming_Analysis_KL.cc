...
int main( int argc, char** argv){
  ...
  for( int ievent  =0; ievent < tr->GetEntries(); ievent++){
    ...
    for( int i  =0; i< 3; i++,pit++){
      Double_t Dist =TMath::Sqrt(TMath::Power(klVec[0].pi0()[i].g1().x()-klVec[0].pi0()[i].g2().x(),2)
				 +TMath::Power(klVec[0].pi0()[i].g1().y()-klVec[0].pi0()[i].g2().y(),2));

      Double_t FL[2];
      Double_t GammaTimeChisq[2];
      Double_t Weight[2] = {0,0};

      FL[0] = TMath::Sqrt( TMath::Power(klVec[0].pi0()[i].g1().x(),2)+TMath::Power(klVec[0].pi0()[i].g1().y(),2)+TMath::Power(klVec[0].pi0()[i].g1().z()-klVec[0].pi0()[i].vz(),2));
      FL[1] = TMath::Sqrt( TMath::Power(klVec[0].pi0()[i].g2().x(),2)+TMath::Power(klVec[0].pi0()[i].g2().y(),2)+TMath::Power(klVec[0].pi0()[i].g2().z()-klVec[0].pi0()[i].vz(),2));
      Double_t DeltaTime = (FL[1]-FL[0])/sol;

      for( int isize = 1; isize < klVec[0].pi0()[i].g1().clusterTimeVec().size(); isize++){
	GammaTimeChisq[0] += TMath::Power(klVec[0].pi0()[i].g1().clusterTimeVec()[isize]-klVec[0].pi0()[i].g1().clusterTimeVec()[0],2)*klVec[0].pi0()[i].g1().e();
	Weight[0]    += klVec[0].pi0()[i].g1().e();
      }
      for( int isize = 1; isize < klVec[0].pi0()[i].g2().clusterTimeVec().size(); isize++){
	GammaTimeChisq[1] += TMath::Power(klVec[0].pi0()[i].g2().clusterTimeVec()[isize]-klVec[0].pi0()[i].g2().clusterTimeVec()[0],2)*klVec[0].pi0()[i].g2().e();
	Weight[1]    += klVec[0].pi0()[i].g2().e();
      }
      GammaTimeChisq[0] = GammaTimeChisq[0]/Weight[0];
      GammaTimeChisq[1] = GammaTimeChisq[1]/Weight[1];

   
      if( abs(klVec[0].pi0()[i].g2().clusterTimeVec()[0]-klVec[0].pi0()[i].g1().clusterTimeVec()[0]-DeltaTime) < 1 ){
	...
	hisGammaTimeChisq[1]->Fill(GammaTimeChisq[1]);
      ...
      hisGammaDistTime->Fill(Dist,klVec[0].pi0()[i].g2().clusterTimeVec()[0]-klVec[0].pi0()[i].g1().clusterTimeVec()[0]-DeltaTime);
      hisGammaTimeDelta->Fill( klVec[0].pi0()[i].g2().clusterTimeVec()[0]-klVec[0].pi0()[i].g1().clusterTimeVec()[0]-DeltaTime);
