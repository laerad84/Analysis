...
main( int argc ,char ** argv ){
  ...
  std::string oFileForm          = "%s/SimPi0_1E6_LYRES_Merged_Positioin_%dcm.root"; // ROOTFILE_SIM3PI0
  ...
  TFile* tfout = new TFile(Form(oFileForm.c_str(),ROOTFILE_SIMPI0.c_str(),Position),"recreate");
