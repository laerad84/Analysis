...
void ARGError(){
  ...
  std::cerr << "Usage: PRG [runNumber] [iterationNumber] [Path] [nDiv] [iDiv]" << std::endl;
}
Int_t 
main(int argc,char** argv)
{
  ...
  /// K3pi0Calibration_Div runNumber iterationNumber path nDiv iDiv
  if( argc  != 6 ){ ARGError(); return -1; }
