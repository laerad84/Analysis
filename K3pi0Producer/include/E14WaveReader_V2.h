...
// Mon Oct 29 03:19:49 2012 by ROOT version 5.30/04
// from TTree Tree/
// found on file: /Volume0/ExpData/2012_Feb_Beam/RootFile_wav/run_wav_4531.root
//////////////////////////////////////////////////////////

#ifndef E14WaveReader_V2_h
#define E14WaveReader_V2_h

#include <TROOT.h>
#include <TChain.h>
#include <TFile.h>

class E14WaveReader_V2 {
public :
   ...
   Double_t        CsiTimeClusterHead[6];   //[CsinTimeCluster]
   Double_t        CsiTimeClusterTail[6];   //[CsinTimeCluster]
   Int_t           CsiTotalEnergyInTimeCluster[6];   //[CsinTimeCluster]
   Double_t        CsiTotalEnergy;
   Int_t           CsinOverFlow;
   Int_t           CsiIDOverFlow[1];   //[CsinOverFlow]
   Int_t           CsinUnderFlow;
   Int_t           CsiIDUnderFlow[1];   //[CsinUnderFlow]
   Int_t           CsiNumber;
   Short_t         CsiID[2475];   //[CsiNumber]
   Int_t           CsiTimeClusterID[2475];   //[CsiNumber]
   Short_t         CsiFitHeight[2475];   //[CsiNumber]
   Short_t         CsiFitTime[2475];   //[CsiNumber]
   Double_t        CsiChisq[2475];   //[CsiNumber]
   Short_t         CsiNDF[2475];   //[CsiNumber]
   Double_t        CsiFitShape[2475];   //[CsiNumber]
   Double_t        CsiDeltaDiff[2475];   //[CsiNumber]
   Double_t        CsiPedestal[2475];   //[CsiNumber]
   Double_t        CsiSignal[2475];   //[CsiNumber]
   Double_t        CsiEne[2475];   //[CsiNumber]
   Double_t        CsiTime[2475];   //[CsiNumber]
   Double_t        CsiHHTime[2475];   //[CsiNumber]
   Double_t        CsiParA[2475];   //[CsiNumber]
   Double_t        CsiParB[2475];   //[CsiNumber]
   Double_t        CsiADC[2475];   //[CsiNumber]
   Double_t        CsiFitADC[2475];   //[CsiNumber]
   Double_t        Csiwav_SlopeDelta[2475];   //[CsiNumber]
   Double_t        Csiwav_Height[2475];   //[CsiNumber]
   Double_t        Csiwav_PeakTime[2475];   //[CsiNumber]
   Double_t        Csiwav_Pedestal[2475];   //[CsiNumber]
   Double_t        Csiwav_Width[2475];   //[CsiNumber]
   Double_t        Csiwav_FrontHalfTime[2475];   //[CsiNumber]
   Double_t        Csiwav_RearHalfTime[2475];   //[CsiNumber]
   Double_t        CsiFit_Pedestal[2475];   //[CsiNumber]
   Double_t        CsiFit_Time[2475];   //[CsiNumber]
   Double_t        CsiFit_Height[2475];   //[CsiNumber]
   Double_t        CsiFit_HHTime[2475];   //[CsiNumber]
   Double_t        CsiFit_ChisqNDF[2475];   //[CsiNumber]
   Double_t        CsiFit_ChisqPed[2475];   //[CsiNumber]
   Double_t        CsiFit_ChisqFront[2475];   //[CsiNumber]
   Double_t        CsiFit_ChisqRear[2475];   //[CsiNumber]
   Double_t        CsiFit_ChisqTail[2475];   //[CsiNumber]
   Double_t        CsiConv_Energy[2475];   //[CsiNumber]
   Double_t        CsiConv_Time[2475];   //[CsiNumber]
   Int_t           CC03nTimeCluster;
   Double_t        CC03TimeClusterHead[1];   //[CC03nTimeCluster]
   Double_t        CC03TimeClusterTail[1];   //[CC03nTimeCluster]
   Int_t           CC03TotalEnergyInTimeCluster[1];   //[CC03nTimeCluster]
   Double_t        CC03TotalEnergy;
   Int_t           CC03nOverFlow;
   Int_t           CC03IDOverFlow[1];   //[CC03nOverFlow]
   Int_t           CC03nUnderFlow;
   Int_t           CC03IDUnderFlow[1];   //[CC03nUnderFlow]
   Int_t           CC03Number;
   ...
   Double_t        OEVTimeClusterHead[1];   //[OEVnTimeCluster]
   Double_t        OEVTimeClusterTail[1];   //[OEVnTimeCluster]
   Int_t           OEVTotalEnergyInTimeCluster[1];   //[OEVnTimeCluster]
   Double_t        OEVTotalEnergy;
   Int_t           OEVnOverFlow;
   Int_t           OEVIDOverFlow[1];   //[OEVnOverFlow]
   Int_t           OEVnUnderFlow;
   Int_t           OEVIDUnderFlow[1];   //[OEVnUnderFlow]
   Int_t           OEVNumber;
   Short_t         OEVID[43];   //[OEVNumber]
   Int_t           OEVTimeClusterID[43];   //[OEVNumber]
   Short_t         OEVFitHeight[43];   //[OEVNumber]
   Short_t         OEVFitTime[43];   //[OEVNumber]
   Double_t        OEVChisq[43];   //[OEVNumber]
   Short_t         OEVNDF[43];   //[OEVNumber]
   Double_t        OEVFitShape[43];   //[OEVNumber]
   Double_t        OEVDeltaDiff[43];   //[OEVNumber]
   Double_t        OEVPedestal[43];   //[OEVNumber]
   Double_t        OEVSignal[43];   //[OEVNumber]
   Double_t        OEVEne[43];   //[OEVNumber]
   Double_t        OEVTime[43];   //[OEVNumber]
   Double_t        OEVHHTime[43];   //[OEVNumber]
   Double_t        OEVParA[43];   //[OEVNumber]
   Double_t        OEVParB[43];   //[OEVNumber]
   Double_t        OEVADC[43];   //[OEVNumber]
   Double_t        OEVFitADC[43];   //[OEVNumber]
   Int_t           CVnTimeCluster;
   Double_t        CVTimeClusterHead[1];   //[CVnTimeCluster]
   Double_t        CVTimeClusterTail[1];   //[CVnTimeCluster]
   Int_t           CVTotalEnergyInTimeCluster[1];   //[CVnTimeCluster]
   Double_t        CVTotalEnergy;
   Int_t           CVnOverFlow;
   Int_t           CVIDOverFlow[1];   //[CVnOverFlow]
   Int_t           CVnUnderFlow;
   Int_t           CVIDUnderFlow[1];   //[CVnUnderFlow]
   Int_t           CVNumber;
   ...
   Double_t        CosmicTimeClusterHead[1];   //[CosmicnTimeCluster]
   Double_t        CosmicTimeClusterTail[1];   //[CosmicnTimeCluster]
   Int_t           CosmicTotalEnergyInTimeCluster[1];   //[CosmicnTimeCluster]
   Double_t        CosmicTotalEnergy;
   Int_t           CosmicnOverFlow;
   Int_t           CosmicIDOverFlow[1];   //[CosmicnOverFlow]
   Int_t           CosmicnUnderFlow;
   Int_t           CosmicIDUnderFlow[1];   //[CosmicnUnderFlow]
   Int_t           CosmicNumber;
   Short_t         CosmicID[19];   //[CosmicNumber]
   Int_t           CosmicTimeClusterID[19];   //[CosmicNumber]
   Short_t         CosmicFitHeight[19];   //[CosmicNumber]
   Short_t         CosmicFitTime[19];   //[CosmicNumber]
   Double_t        CosmicChisq[19];   //[CosmicNumber]
   Short_t         CosmicNDF[19];   //[CosmicNumber]
   Double_t        CosmicFitShape[19];   //[CosmicNumber]
   Double_t        CosmicDeltaDiff[19];   //[CosmicNumber]
   Double_t        CosmicPedestal[19];   //[CosmicNumber]
   Double_t        CosmicSignal[19];   //[CosmicNumber]
   Double_t        CosmicEne[19];   //[CosmicNumber]
   Double_t        CosmicTime[19];   //[CosmicNumber]
   Double_t        CosmicHHTime[19];   //[CosmicNumber]
   Double_t        CosmicParA[19];   //[CosmicNumber]
   Double_t        CosmicParB[19];   //[CosmicNumber]
   Double_t        CosmicADC[19];   //[CosmicNumber]
   Double_t        CosmicFitADC[19];   //[CosmicNumber]
   Int_t           LasernTimeCluster;
   Double_t        LaserTimeClusterHead[1];   //[LasernTimeCluster]
   Double_t        LaserTimeClusterTail[1];   //[LasernTimeCluster]
   Int_t           LaserTotalEnergyInTimeCluster[1];   //[LasernTimeCluster]
   Double_t        LaserTotalEnergy;
   Int_t           LasernOverFlow;
   Int_t           LaserIDOverFlow[1];   //[LasernOverFlow]
   Int_t           LasernUnderFlow;
   Int_t           LaserIDUnderFlow[1];   //[LasernUnderFlow]
   Int_t           LaserNumber;
   ...
   Double_t        EtcTimeClusterHead[1];   //[EtcnTimeCluster]
   Double_t        EtcTimeClusterTail[1];   //[EtcnTimeCluster]
   Int_t           EtcTotalEnergyInTimeCluster[1];   //[EtcnTimeCluster]
   Double_t        EtcTotalEnergy;
   Int_t           EtcnOverFlow;
   Int_t           EtcIDOverFlow[1];   //[EtcnOverFlow]
   Int_t           EtcnUnderFlow;
   Int_t           EtcIDUnderFlow[1];   //[EtcnUnderFlow]
   Int_t           EtcNumber;
   ...
   E14WaveReader_V2(TTree *tree=0);
   virtual ~E14WaveReader_V2();
...
#ifdef E14WaveReader_V2_cxx
E14WaveReader_V2::E14WaveReader_V2(TTree *tree)
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
  /*
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/Volume0/ExpData/2012_Feb_Beam/RootFile_wav/run_wav_4531.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/Volume0/ExpData/2012_Feb_Beam/RootFile_wav/run_wav_4531.root");
      }
...
E14WaveReader_V2::~E14WaveReader_V2()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t E14WaveReader_V2::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t E14WaveReader_V2::LoadTree(Long64_t entry)
{
...
void E14WaveReader_V2::Init(TTree *tree)
{
...
Bool_t E14WaveReader_V2::Notify()
{
...
void E14WaveReader_V2::Show(Long64_t entry)
{
...
Int_t E14WaveReader_V2::Cut(Long64_t entry)
{
...
#endif // #ifdef E14WaveReader_V2_cxx
