// -*- C++ -*-
//
// ClusterFinder_EDIT.h
// csi clustering
//
// Author:  Kazufumi Sato
// Created: Fri Aug  26 10:48:00 JST 2011
//
// $Id: ClusterFinder_EDIT.h,v 1.1 $
//
// $Log: ClusterFinder_EDIT.h,v $
//
...
#ifndef CLUSTERFINDER_EDIT_H_INCLUDED
#define CLUSTERFINDER_EDIT_H_INCLUDED
...
class ClusterFinder_EDIT {
public:
  // constructor
  ClusterFinder_EDIT(double threshold = 3, int debugLevel=0 );
