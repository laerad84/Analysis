...
/////
ClusterFinder_EDIT::ClusterFinder_EDIT( double threshold,int debugLevel )
...
/////
ClusterFinder_EDIT::~ClusterFinder_EDIT()
{
  deleteKS();
}

void ClusterFinder_EDIT::constructKS(){
  ;
}
void ClusterFinder_EDIT::deleteKS(){
  ;
}
/*
double ClusterFinder_EDIT::showerLeakage(double thre,double E,double ws,double wl){
...
*/
std::list<Cluster>& 
ClusterFinder_EDIT::findCluster(TClonesArray const *csiDigi )
{
...
ClusterFinder_EDIT::findCluster(int nDigi,int *ID,double *E,double *time )
{
  ...
  while(templist.size()>0){
    ...
    // added by JWLEE for test 
    double maximumE = csiData.Edep;
