...
int main( int argc , char** argv ){
  ...
  for (int index = 0; index <10 ; index++){
    ...
    for( int ibin  = 0; ibin < 10; ibin++){
      ...
      his_Slice_L[index][ibin] = hist_R_Theta_Time[index]->ProjectionY(his_Slice_L[index][ibin]->GetName(),ibin+1,ibin+2);
    }
    ...
    for( int ibin = 0; ibin < 10 ; ibin++){
      ...
      his_Slice_R_Plus[index][ibin]->Fit("gaus","","",
      ...
      his_Slice_R_Plus[index][ibin]->Fit("gaus","","",mean_RP_Fit-RMS_RP_Fit,
    ...
    for( int ibin = 0; ibin < 10 ; ibin++){
      ...
      his_Slice_R_Minus[index][ibin]->Fit("gaus","","",
					 mean_RP-RMS_RP, mean_RP+RMS_RP);
      TF1* func  = his_Slice_R_Minus[index][ibin]->GetFunction("gaus");
      double mean_RP_Fit = func->GetParameter(1);
      double RMS_RP_Fit  = func->GetParameter(2);
      his_Slice_R_Minus[index][ibin]->Fit("gaus","","",mean_RP_Fit-RMS_RP_Fit,
					 mean_RP_Fit+RMS_RP_Fit);
    ...
    for( int ibin = 0; ibin < 10 ; ibin++){
      ...
      his_Slice_D[index][ibin]->Fit("gaus","","",
      ...
      his_Slice_D[index][ibin]->Fit("gaus","","",mean_DP_Fit-RMS_DP_Fit,
    ...
    for( int ibin = 0; ibin < 10 ; ibin++){
      ...
      his_Slice_L[index][ibin]->Fit("gaus","","",
      ...
      his_Slice_L[index][ibin]->Fit("gaus","","",mean_LP_Fit-RMS_LP_Fit,
